...
fn sketch() -> error::Result<()> {
    ...
    material_set(glow, "roughness", material::MaterialValue::Float(0.3))?;
    material_set(glow, "metallic", material::MaterialValue::Float(0.5))?;
    // HDR emissive — values > 1.0 produce bloom/glow
    material_set(glow, "emissive", material::MaterialValue::Float4([2.0, 0.5, 3.0, 1.0]))?;
